...
export const createProjectController = async (req, res) => {
  try {
    ...
    const normalizedPayload = {
      ...
      owner_email: normalizeOptionalText(
        req.user?.email ?? req.body?.owner_email,
      ),
...
export const updateProject = async (req, res) => {
  try {
    ...
    const rawPayload = {
      ...
      owner_email: normalizeOptionalText(req.body?.owner_email),
      owner_name: normalizeOptionalText(req.body?.owner_name),
      owner_username: normalizeOptionalText(req.body?.owner_username),
      owner_avatar_url: normalizeOptionalText(req.body?.owner_avatar_url),
    };
    ...
    const normalizedPayload = Object.fromEntries(
      Object.entries({
        ...
        owner_email: normalizeOptionalText(validatedData?.owner_email),
